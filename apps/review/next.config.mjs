...
const nextConfig = {
  // Strict mode is disabled here to avoid diff request thrash in dev: the
  // viewer fires patch fetches on mount, and double-invoked effects would
  // double those requests.
